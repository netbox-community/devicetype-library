...
def extract_data(releaseTag: str, repo_path: str):
    with tempfile.TemporaryDirectory() as tempdir:
        ...
        urlretrieve(
            f"https://raw.githubusercontent.com/netbox-community/netbox/{releaseTag}/contrib/generated_schema.json",
            tmpfile,
        )
...
def __init__():
    ...
    repo_path = os.path.abspath(
        os.path.join(os.path.dirname(__file__), "../schema/generated_schema.json")
    )
