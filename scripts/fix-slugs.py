                ...
                try:
                    ...
                    for idx, line in enumerate(data):
                        if "manufacturer: " in line:
                            ...
                            slugManufacturer = (
                                line.split(": ")[1].casefold().replace(" ", "-").strip()
                            )
                    ...
                    transformedManufacturer = (
                        slugManufacturer.casefold()
                        .replace(" ", "-")
                        .replace("sfp+", "sfpp")
                        .replace("poe+", "poep")
                        .replace("-+", "-plus-")
                    ...
                    if "&" in transformedManufacturer:
                        transformedManufacturer = transformedManufacturer.replace(
                            "&", "-and-"
                        )
                    ...
                    newComboSlug = (
                        f"{slugManufacturer}-{transformedModel}-{transformedPartNumber}"
                    )
                    ...
                    if slugManufacturer != "apple":
                        ...
                        if newPartSlug.count(slugManufacturerDash) > 1:
                            newPartSlug = newPartSlug.replace(
                                f"{slugManufacturer}-", "", 1
                            )
                        if newComboSlug.count(slugManufacturerDash) > 1:
                            newComboSlug = newComboSlug.replace(
                                f"{slugManufacturer}-", "", 1
                            )
                        ...
                        if (
                            newSlug != slug
                            and newPartSlug != slug
                            and newComboSlug != slug
                        ):
